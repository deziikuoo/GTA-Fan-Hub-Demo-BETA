...
<template>
  <div class="missions">
    <div class="coming-soon-card">
      <h2>Missions Page Coming Soon</h2>
      <p>
        We're working hard to add the latest GTA 6 mission details.<br />
        Stay tuned for updates as new information is revealed!
      </p>
    ...
    <div class="dev-message">
      <h3>Message to Dev:</h3>
      <ul>
        <li>Mission walkthroughs and guides</li>
        <li>Mission objectives and rewards</li>
        <li>Difficulty ratings and strategies</li>
        <li>Mission prerequisites and unlock conditions</li>
      </ul>
    </div>
  </div>
</template>
...
.dev-message li {
  ...
  margin: 0.5rem 0;
  padding: 0.5rem;
  background: rgba(255, 41, 72, 0.1);
  border-radius: 8px;
  border-left: 3px solid #ff2948;
}
</style>
