...
<template>
  <div class="lore">
    <div class="coming-soon-card">
      <h2>Lore Page Coming Soon</h2>
      <p>
        We're working hard to add the latest GTA 6 lore and worldbuilding
        details.<br />
    ...
    <div class="dev-message">
      ...
      <ul>
        <li>GTA universe connections and references</li>
        <li>Leonida state history and culture</li>
        <li>Criminal organizations and factions</li>
        <li>Easter eggs and hidden details</li>
      </ul>
    </div>
  </div>
</template>
